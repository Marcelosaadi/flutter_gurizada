...
class CadastroEntregaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Registro de Compra de Produtos'),
      ),
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20), // Espaço entre os campos de texto e o botão
              ...
              ElevatedButton(
                ...
                child:
                    Text('Registrar Entrega', style: TextStyle(fontSize: 16)),
              ),
            ],
          ),
        ),
